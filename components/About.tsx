  ...
  const features = [
    {
      ...
      description: "Төрөлх япон хэлтэй багш 10+ жилийн заах туршлагатай",
    },
    {
      icon: Award,
      title: "JLPT бэлтгэл",
      description: "Бүх JLPT түвшний (N5-N1) дэлгэрэнгүй бэлтгэл",
    },
    {
      icon: Globe,
      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Манай дэлгэрэнгүй япон хэлний сургалт нь таныг бүрэн анхлан
              суралцагчаас дэлгэрэнгүй мэдлэгтэй болтол хөтлөхөөр зохион
              байгуулагдсан. Жинхэнэ заах арга, соёлын ойлголт, хувийн сургалтын
              замтай та япон хэлийг байгалийн байдлаар, үр дүнтэй эзэмшиж чадна.
            </motion.p>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl relative">
              ...
              <div className="w-full h-80 bg-gradient-to-br from-sakura-100 to-matcha-100 rounded-2xl mb-6 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-fuji-600">Төрөлх япон хэлтэй багш</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-matcha-50 rounded-xl p-4 text-center">
                  ...
                  <div className="text-sm text-matcha-700">Сурагч заасан</div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-fuji-50 to-sakura-50 rounded-2xl p-6">
                ...
                <p className="text-fuji-600 text-sm leading-relaxed">
                  Отгонцэцэг нь монголын булангаас ирсэн сурагчдад арван гаруй
                  жил заасан туршлагатай сертификаттай япон хэлний багш юм.
                  Монголд төрж өссөн тэрээр жинхэнэ соёлын ойлголт, төрөлх
                  хэлний дуу авиаг бүх хичээлд авчирдаг.
                </p>
              </div>
